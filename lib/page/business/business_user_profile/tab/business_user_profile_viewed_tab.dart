...
import 'package:eportal/page/business/business_user_profile/widget/business_user_profile_viewed_item.dart';
...
class BusinessUserProfileViewedTab extends BasePageWidget {
  const BusinessUserProfileViewedTab({super.key});

  @override
  State<StatefulWidget> createState() => BusinessUserProfileViewedTabState();
}

class BusinessUserProfileViewedTabState extends BasePageKeepState<BusinessUserProfileViewedTab> {
  ...
  ProfileViewListEvent profileViewListEvent = ProfileViewListEvent(request: ProfileViewListRequest(obj: ProfileViewListDataRequest()));
  ...
  void getMoreData() {
    ...
    profileViewListEvent.request.obj.nextData();
    callApi();
  }

  @override
  void initDataLoading() {
    profileViewListEvent.request.obj.reloadData();
    callApi();
  }
  ...
  void callApi() {
    ...
    profileViewListEvent.request.obj.tuKhoa = textEditingController.text;
    profileViewListBloc.add(profileViewListEvent);
  }
                    ...
                    builder: (BuildContext context,
                        ...
                        handleDataPageState<ProfileViewListDataResponse>(
                          state,
                            ...
                            children: state.map((e) => BusinessUserProfileViewedItem(data: e,
                              onClickItem: (ProfileViewListDataResponse value) => showChooseAction(value),
                            )).toList(),),
                        ),
                  ),
                )),
  ...
  void showChooseAction(ProfileViewListDataResponse value) {
