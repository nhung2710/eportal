...
// Copyright (c) 2024 Hilo All rights reserved.
//
class BusinessUserProfileBlockItem extends StatelessWidget{
  final ProfileBlackListDataResponse data;
  final ValueChanged<ProfileBlackListDataResponse> onClickItem;

  const BusinessUserProfileBlockItem({super.key,required this.data,required this.onClickItem});
  @override
