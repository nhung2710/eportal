...
// Copyright (c) 2024 Hilo All rights reserved.
//
class BusinessUserProfileViewedItem extends StatelessWidget{
  final ProfileViewListDataResponse data;
  final ValueChanged<ProfileViewListDataResponse> onClickItem;

  const BusinessUserProfileViewedItem({super.key,required this.data,required this.onClickItem});
  @override
