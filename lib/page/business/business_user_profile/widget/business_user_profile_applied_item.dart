...
class BusinessUserProfileAppliedItem extends StatelessWidget{
  final ProfileSendListDataResponse data;
  final ValueChanged<ProfileSendListDataResponse> onClickItem;

  const BusinessUserProfileAppliedItem({super.key,required this.data,required this.onClickItem});
  @override
