...
class UserProfileBasicTabState extends BasePageKeepState<UserProfileBasicTab>{
  ...
  DanhSachNganhNgheEvent danhSachNganhNgheEvent = DanhSachNganhNgheEvent(request:  DanhSachNganhNgheRequest(obj: DanhSachNganhNgheDataRequest()));
  ...
  GlobalKey<DefaultSelectItemDataResponseState> keyQuanHuyen = GlobalKey<DefaultSelectItemDataResponseState>();
