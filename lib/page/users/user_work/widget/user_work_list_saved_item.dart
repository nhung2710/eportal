...
class UserWorkListSavedItem extends StatelessWidget{
  final WorkSaveListDataResponse data;
  final ValueChanged<WorkSaveListDataResponse> onClickItem;

  const UserWorkListSavedItem({super.key,required this.data,required this.onClickItem});
  @override
