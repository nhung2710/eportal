...
class UserWorkListViewedItem extends StatelessWidget{
  final WorkViewListDataResponse data;
  final ValueChanged<WorkViewListDataResponse> onClickItem;

  const UserWorkListViewedItem({super.key,required this.data,required this.onClickItem});
  @override
