...
class UserWorkListViewedTab extends BasePageWidget {
  const UserWorkListViewedTab({super.key});

  @override
  State<StatefulWidget> createState() => UserWorkListViewedTabState();
}

class UserWorkListViewedTabState extends BasePageKeepState<UserWorkListViewedTab> {
