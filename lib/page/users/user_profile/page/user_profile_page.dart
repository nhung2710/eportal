...
class UserProfilePageState extends BasePageState<UserProfilePage> {
    ...
    showBaseBottomSheet(children: [
      GestureDetector(
        onTap: () {
          ...
          nextPage((context) => UserProfileEditPage(
                data: value,
              )).then((value) {
            if (value == true) {
              initDataLoading();
      ...
      GestureDetector(
        onTap: () {
          Navigator.pop(context);
          nextPage((context) => ReferencePage(
                userProfileId: value.jobUserID,
              ));
        },
        child: ListTile(
          leading: const Icon(
      ...
      GestureDetector(
        onTap: () {
          Navigator.pop(context);
          nextPage((context) =>
              UserProfileHistoryPage(userProfileId: value.jobUserID));
        },
        child: ListTile(
          leading: const Icon(
