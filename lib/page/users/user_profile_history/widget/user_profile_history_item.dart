...
class UserProfileHistoryItem extends StatelessWidget{
  final JobUserHistoryListDataResponse data;
  final ValueChanged<JobUserHistoryListDataResponse> onClickItem;

  const UserProfileHistoryItem({super.key,required this.data,required this.onClickItem});
  @override
        ...
        children: [
          Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(child: Text(data.search.supportHtml(),style: AppTextStyle.titlePage.copyWith(),maxLines: 1,textAlign: TextAlign.start,)),
                ],
              )
          ),
          Divider(
          ...
          Container(
              ...
              child: Align(
                  ...
                  child: Text("${data.search.formatDateTimeApi()} - ${data.search.formatDateTimeApi()}",style: AppTextStyle.normalChild1.copyWith(color: Colors.red),maxLines: 2,textAlign: TextAlign.end,))
          )
        ],
      ),
    ),
