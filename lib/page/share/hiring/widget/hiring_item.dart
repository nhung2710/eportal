...
class HiringItem extends StatelessWidget{
  final HomeWorksListDataResponse data;
  final ValueChanged<HomeWorksListDataResponse> onClickItem;

  const HiringItem({super.key,required this.data,required this.onClickItem});
  @override
