...
class ProfileItem extends StatelessWidget{
  final HomeJobUserListDataResponse data;
  final ValueChanged<HomeJobUserListDataResponse> onClickItem;

  const ProfileItem({super.key,required this.data,required this.onClickItem});
  @override
