...
class ProfileSearchFilterPage extends BasePageWidget {
  final JobUserSearchEvent data;
  const ProfileSearchFilterPage({super.key,required this.data});

  @override
  State<StatefulWidget> createState() => ProfileSearchFilterPageState();
}

class ProfileSearchFilterPageState extends BasePageState<ProfileSearchFilterPage> {
