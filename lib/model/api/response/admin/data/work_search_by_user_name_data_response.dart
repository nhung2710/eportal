...
class WorkSearchByUserNameDataResponse extends BaseEportalDataResponse {
  String? imageURL;
  String? tenTinhTP;
  String? hanNopHoSo;
  ...
  WorkSearchByUserNameDataResponse.fromJson(Map<String, dynamic> json) {
    ...
    gtvl = json.toStringJson(path: 'gtvl');
    ...
    ketQuaPhongVan = json.toStringJson(path: 'ketQuaPhongVan');
    levelDesiredID = json.toStringJson(path: 'levelDesired_ID');
    isFlag = json.toStringJson(path: 'isFlag');
    isView = json.toStringJson(path: 'isView');
    isSend = json.toStringJson(path: 'isSend');
    ...
    quantity = json.toStringJson(path: 'quantity');
    experienceID = json.toStringJson(path: 'experience_ID');
    gender = json.toStringJson(path: 'gender');
    ...
    portalID = json.toStringJson(path: 'portalID');
  }
