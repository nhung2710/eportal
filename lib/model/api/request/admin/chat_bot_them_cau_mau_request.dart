...
class ChatBotThemCauMauRequest extends BaseEportalRequest<ChatBotThemCauMauDataRequest> {
  ChatBotThemCauMauRequest({required super.obj});

  @override
  String getQuery() => ApplicationApiConstant.kAPI_ADMIN_OP_CHAT_BOT_THEM_CAU_MAU;
