...
class ChatBotChiTietHoiThoaiRequest extends BaseEportalRequest<ChatBotChiTietHoiThoaiDataRequest> {
  ChatBotChiTietHoiThoaiRequest({required super.obj});

  @override
  String getQuery() => ApplicationApiConstant.kAPI_ADMIN_OP_CHAT_BOT_CHI_TIET_HOI_THOAI;
