...
class HomeNewsListRepository
    extends BaseRepository<HomeNewsListRequest, HomeNewsListResponse> {
  @override
  HomeNewsListResponse mapJsonToObject(Map<String, dynamic> value) =>
      HomeNewsListResponse.fromJson(value);
}
