...
class ListOfCandidateProfileTab extends BasePage {
  const ListOfCandidateProfileTab({super.key});

  @override
  State<StatefulWidget> createState() => _ListOfCandidateProfileTabState();
}

class _ListOfCandidateProfileTabState
    extends BasePageStateActive<ListOfCandidateProfileTab> {
