...
import 'package:eportal/screen/forgot_password/page/forgot_password_page.dart';
  ...
  _signInAsync(BuildContext context) {
    if(isValid()){
      ...
      .then((value){
          ...
          nextPage((context) => const DashboardWorkerPage());
      });
    }
  }
  ...
  _signInBusinessAsync(BuildContext context) {
    if(isValid()){
      ...
      .then((value){
        ...
        GlobalApplication().UserName = nameController.text;
        GlobalApplication().UserPassword = passwordController.text;
        nextPage((context) => const DashboardBusinessPage());
      });
