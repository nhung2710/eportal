...
//
class ManagementOfNewsEditPage extends BasePage {
  const ManagementOfNewsEditPage({super.key});

  @override
  State<StatefulWidget> createState() => _ManagementOfNewsEditPageState();
}

class _ManagementOfNewsEditPageState
    extends BasePageState<ManagementOfNewsEditPage> {
