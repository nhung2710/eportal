...
//
class ManagementOfEventsEditPage extends BasePage {
  const ManagementOfEventsEditPage({super.key});

  @override
  State<StatefulWidget> createState() => _ManagementOfEventsEditPageState();
}

class _ManagementOfEventsEditPageState
    extends BasePageState<ManagementOfEventsEditPage> {
