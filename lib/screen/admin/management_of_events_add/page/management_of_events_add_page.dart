...
//
class ManagementOfEventsAddPage extends BasePage {
  const ManagementOfEventsAddPage({super.key});

  @override
  State<StatefulWidget> createState() => _ManagementOfEventsAddPageState();
}

class _ManagementOfEventsAddPageState
    extends BasePageState<ManagementOfEventsAddPage> {
