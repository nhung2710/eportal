...
class ManagementOfBannersEditPage extends BasePage {
  const ManagementOfBannersEditPage({super.key});

  @override
  State<StatefulWidget> createState() => _ManagementOfBannersEditPageState();
}

class _ManagementOfBannersEditPageState
    extends BasePageState<ManagementOfBannersEditPage> {
  ...
  @override
  String getPageTitle(BuildContext context) => "Sửa banner";
