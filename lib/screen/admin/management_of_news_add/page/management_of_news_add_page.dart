...
//
class ManagementOfNewsAddPage extends BasePage {
  const ManagementOfNewsAddPage({super.key});

  @override
  State<StatefulWidget> createState() => _ManagementOfNewsAddPageState();
}

class _ManagementOfNewsAddPageState
    extends BasePageState<ManagementOfNewsAddPage> {
