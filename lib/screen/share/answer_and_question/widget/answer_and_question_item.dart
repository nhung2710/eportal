              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Container(
                      ...
                      child: Text("Vấn đề $index",textAlign: TextAlign.start,style: AppTextStyle.title.copyWith(color:Colors.blue))
                  ),
                ),
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  ...
                  child: Container(
                      margin: const EdgeInsets.only(right: 10,left: 10),
                      child: Text("Kết quả $index",textAlign: TextAlign.start,style: AppTextStyle.title.copyWith(color:Colors.blue))
                  ),
                ),
                const Icon(Icons.navigate_next_sharp,color: Colors.blue,size: 20,)
              ],
