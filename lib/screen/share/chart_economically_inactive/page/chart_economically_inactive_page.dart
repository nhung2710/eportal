...
class ChartEconomicallyInactivePage extends BasePage {
  const ChartEconomicallyInactivePage({super.key});

  final Color dark = Colors.blue;
  final Color normal = Colors.cyan;
  final Color light = Colors.black;

  @override
  State<StatefulWidget> createState() => _ChartEconomicallyInactivePageState();
}

class _ChartEconomicallyInactivePageState
    extends BasePageState<ChartEconomicallyInactivePage> {
  ...
  @override
  String getPageTitle(BuildContext context) => "Lao động không hoạt động";
