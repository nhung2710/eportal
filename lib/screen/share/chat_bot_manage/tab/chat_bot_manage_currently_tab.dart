...
import '../../../../bloc/admin/chat_bot_danh_dau_sao_bloc.dart';
import '../../../../bloc/admin/chat_bot_xoa_hoi_thoai_bloc.dart';
import '../../../../event/admin/chat_bot_danh_dau_sao_event.dart';
import '../../../../model/api/request/admin/chat_bot_danh_dau_sao_request.dart';
import '../../../../model/api/request/admin/data/chat_bot_chi_tiet_hoi_thoai_data_request.dart';
import '../../../../model/api/request/admin/data/chat_bot_danh_dau_sao_data_request.dart';
import '../../../../model/api/request/admin/data/chat_bot_xoa_hoi_thoai_data_request.dart';
...
class ChatBotManageCurrentlyTabState
  ...
  ChatBotDanhSachHoiThoaiRequest chatBotDanhSachHoiThoaiRequest =
      ChatBotDanhSachHoiThoaiRequest(
          obj: ChatBotDanhSachHoiThoaiDataRequest(trangThai: 1));
