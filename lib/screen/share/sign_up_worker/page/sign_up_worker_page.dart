...
class SignUpWorkerPage extends BasePage {
  const SignUpWorkerPage({super.key});

  @override
  State<StatefulWidget> createState() => _SignUpWorkerPageState();
}

class _SignUpWorkerPageState extends BasePageState<SignUpWorkerPage> {
