...
class ChatBotChiTietHoiThoaiBloc extends BaseMultiBloc<
    ChatBotChiTietHoiThoaiDataResponse,
    ChatBotChiTietHoiThoaiRepository,
    ChatBotChiTietHoiThoaiEvent,
    ChatBotChiTietHoiThoaiResponse> {
  @override
  Future<ChatBotChiTietHoiThoaiResponse> callApiResult(
          ChatBotChiTietHoiThoaiRepository apiRepository,
          ChatBotChiTietHoiThoaiEvent event) =>
  ...
  @override
  ChatBotChiTietHoiThoaiRepository getRepository() =>
      ChatBotChiTietHoiThoaiRepository();
}
