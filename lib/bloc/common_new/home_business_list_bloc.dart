...
class HomeBusinessListBloc extends Bloc<BaseEvent, DataState<List<HomeBusinessListDataResponse>>> {
  HomeBusinessListBloc() : super(const DataState<List<HomeBusinessListDataResponse>>()) {
